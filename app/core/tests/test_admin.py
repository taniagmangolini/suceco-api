...
class AdminSiteTest(TestCase):
    """Tests for Core Admin."""

    def setUp(self):
        """Create an admin user and a normal user.
            Firstly it creates an admin user and force authentication.
            After that, it creates a regular user.
        """
        self.client = Client()
